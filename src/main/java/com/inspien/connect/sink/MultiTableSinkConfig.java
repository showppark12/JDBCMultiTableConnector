...
public class MultiTableSinkConfig extends AbstractConfig {
    ...
    public MultiTableSinkConfig(Map<?, ?> props) {
    ...
    public static JdbcSinkConfig createJdbcSinkConfig(Map<String, String> props) {
        props.put("insert.mode", "insert");
        props.put("pk.fields", "none");
