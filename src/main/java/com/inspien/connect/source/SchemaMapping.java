...
public final class SchemaMapping {
    ...
    /**
     * Get the {@link io.confluent.connect.jdbc.source.SchemaMapping.FieldSetter} functions, which contain one for each result set column whose
     * values are to be mapped/converted and then set on the corresponding {@link Field} in supplied
     * {@link Struct} objects.
     *
     * @return the array of {@link io.confluent.connect.jdbc.source.SchemaMapping.FieldSetter} instances; never null and never empty
     */
